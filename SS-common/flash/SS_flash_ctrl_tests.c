...
{
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_init());
}
...
TEST(flash_ctrl, logging_start_stop)
{
    ...
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_DISABLED, SS_flash_ctrl_start_logging());

    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_stop_logging());
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_DISABLED, SS_flash_ctrl_stop_logging());
}

TEST(flash_ctrl, erase)
{
    TEST_MESSAGE("Testing log erase. This may take up to 500 seconds...");
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_erase_logs());
...
TEST(flash_ctrl, logging1)
{
    ...
    static uint8_t data2[] = {0xAA, 0xBB, 0xCC, 0xDD};
    static uint8_t data3[] = {0x11, 0x22, 0x33, 0x44};

    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_start_logging());
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x01, data1, 4));
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x02, data2, 4));
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x03, data3, 4));
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_stop_logging());
    ...
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_s25fl_read_page_dma_wait(0x00089200UL/S25FL_PAGE_SIZE, data));
...
{
    static uint8_t data1[] = {0xAA, 0xAA, 0xBB, 0xBB};
    static uint8_t data2[] = {0xCC, 0xCC, 0xDD, 0xDD};
    static uint8_t data3[] = {0xEE, 0xEE, 0xFF, 0xFF};

    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_start_logging());
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x04, data1, 4));
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x04, data2, 4));
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x04, data3, 4));
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_stop_logging());
    ...
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_read_page_dma_wait(0x00089200UL/S25FL_PAGE_SIZE + 1, data));
    TEST_ASSERT_EQUAL_INT(0, memcmp(&data[3], data1, 4));
    TEST_ASSERT_EQUAL_INT(0, memcmp(&data[10], data2, 4));
    TEST_ASSERT_EQUAL_INT(0, memcmp(&data[17], data3, 4));
}
...
TEST(flash_ctrl, logging3)
{
    ...
    for (uint32_t i = 0; i < S25FL_PAGE_SIZE/7 + 1; ++i) {
        TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_log_var(FLASH_STREAM_VAR, 0x05, (uint8_t *)&i, 4));
    ...
    TEST_ASSERT_EQUAL_INT(FLASH_STATUS_OK, SS_flash_ctrl_read_page_dma_wait(0x00089200UL/S25FL_PAGE_SIZE + 2, data));
...
// TODO: Add logging4 test that will fill an entire byte in the journal.
// TODO: Add tests for text stream logging.
