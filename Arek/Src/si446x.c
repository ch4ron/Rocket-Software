...
void SI446X_set_frequency(uint32_t tx_frequency, uint16_t frequency_deviation) {
    ...
    if(tx_frequency < 960000000UL) {
        outdiv = 4;
        FVCO_DIV = 0;
    };
    if(tx_frequency < 705000000UL) {
        outdiv = 6;
        FVCO_DIV = 1;
    };
    if(tx_frequency < 470000000UL) {
        outdiv = 8;
        FVCO_DIV = 2;
    };
    if(tx_frequency < 353000000UL) {
        outdiv = 12;
        FVCO_DIV = 3;
    };
    if(tx_frequency < 235000000UL) {
        outdiv = 16;
        FVCO_DIV = 4;
    };
    if(tx_frequency < 177000000UL) {
        outdiv = 24;
        FVCO_DIV = 5;
    };
