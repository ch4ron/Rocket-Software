...
static struct MocktaskInstance
{
  ...
  char xTaskGetIdleRunTimeCounter_IgnoreBool;
  TickType_t xTaskGetIdleRunTimeCounter_FinalReturn;
...
void Mocktask_Verify(void)
{
  ...
  if (Mock.xTaskGetIdleRunTimeCounter_IgnoreBool)
    call_instance = CMOCK_GUTS_NONE;
  if (CMOCK_GUTS_NONE != call_instance)
  {
...
TickType_t xTaskGetIdleRunTimeCounter(void)
{
  ...
  if (Mock.xTaskGetIdleRunTimeCounter_IgnoreBool)
  {
    UNITY_CLR_DETAILS();
    if (cmock_call_instance == NULL)
      return Mock.xTaskGetIdleRunTimeCounter_FinalReturn;
    memcpy((void*)(&Mock.xTaskGetIdleRunTimeCounter_FinalReturn), (void*)(&cmock_call_instance->ReturnVal),
         sizeof(TickType_t[sizeof(cmock_call_instance->ReturnVal) == sizeof(TickType_t) ? 1 : -1])); /* add TickType_t to :treat_as_array if this causes an error */
    return cmock_call_instance->ReturnVal;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
...
void xTaskGetIdleRunTimeCounter_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, TickType_t cmock_to_return)
{
  ...
  Mock.xTaskGetIdleRunTimeCounter_IgnoreBool = (char)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ExpectAnyArgsBool = (char)0;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.xTaskGetIdleRunTimeCounter_IgnoreBool = (char)1;
}
